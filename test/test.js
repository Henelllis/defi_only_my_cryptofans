...
contract("OnlyMyCryptoFans", ([deployer, author, tipper]) => {
  ...
  before(async () => {
    OnlyMyCryptoFans = await OnlyMyCryptoFans.deployed();
  });

  describe("deployment", async () => {
    it("deploys successfully", async () => {
      const address = await OnlyMyCryptoFans.address;
    ...
    it("has a name", async () => {
      const name = await OnlyMyCryptoFans.name();
      assert.equal(name, "OnlyMyCryptoFans");
    });
  });
